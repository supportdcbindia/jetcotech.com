...
$phone = "+91 75750 07163"; /* FORMATE: +91 00000 00000 */
$phone1 = "+91 63518 97900"; /* FORMATE: +91 00000 00000 */
$whatappphone = "917575007163";/* FORAMTE: 91000000000 */
$email = "sales@jetcotech.in";
$email1 = "marketing@jetcotech.in";
$logo = "images/logo-2.png"; /* FORMATE: images/logo3.png */
                        ...
                        <div class="logo-wrapper">
                            ...
                            <button class="btn-modal-gra">
                                <a class="content-p" href="mailto:<?=$email;?>"
                                    onclick="gtag('event', 'send', { 'event_category': 'click on mail', 'event_action': 'mailto', 'event_label': '<?=$email;?>' });"><b><?=$email;?></b></a><br><a
                                    class="content-p" href="mailto:<?=$email1;?>"
                                    onclick="gtag('event', 'send', { 'event_category': 'click on mail', 'event_action': 'mailto', 'event_label': '<?=$email1;?>' });"><b><?=$email1;?></b></a>
                                <br> <a class="content-p" href="tel:<?=$phone?>"
                                    ...
                                    <b><?=$phone?></b></a><br><a class="content-p" href="tel:<?=$phone1?>"
                                    onclick="gtag('event', 'send', { 'event_category': 'click on Mobile', 'event_action': 'Mobile', 'event_label': '<?=$phone1?>' });">
                                    <b><?=$phone1?></b></a>
                            </button>
                        </div>
                    </div>
...
<!-- end catelog model -->
<!-- Exhibition Popup Model -->
<!--<div class="modal fade bs-example-modal-sm cstm-modal-top-header my-custom-modal" tabindex="-1" role="dialog"-->
<!--    aria-labelledby="myLargeModalLabel" aria-hidden="true" id="onload5">-->
<!--    <div class="modal-dialog modal-sm">-->
<!--        <div class="modal-content">-->
<!--            <div class="modal-body ">-->
...
<!--                        <img src="images/exhibitions/jetcotech-elecrama-&-maha-tech-2025-combined.jpg" class="img-fluid" />-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
...
<div class="footer-box" style="display: none;">
    <div class="book-app" style="background:#f58634;" id="req-apnmt2">
    ...
    <div class="book-app" style="background: #222;">
        <a class="nav_up" href="catalogue.html" style="color:#FFF; font-size:12px;font-weight:600;"><i
