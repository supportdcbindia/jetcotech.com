...
<head>
    ...
    $productName = "Embossed Perforated Cable Tray";
...
<body>
    <div class="page-wrapper product">
        ...
        <section class="page-title" style="background-image:url(images/background/wire-mesh-cable-tray-bg.jpg)">
            <div class="auto-container">
                <div class="content">
                    <h1>Embossed Perforated Cable Tray <?= ucfirst($type); ?> in <?= ucfirst($city); ?></h1>
                    <ul class="page-breadcrumb">
                        <li><a href="index.html">Home</a></li>
                        <li>Cable Tray</li>
                        <li>Embossed Perforated Cable Tray</li>
                    </ul>
                </div>
            </div>
        </section>
                                    ...
                                    <div id="pdrzoom" class="ubislider right ecommerce" data-slidetime="0">
                                        ...
                                        <ul id="gal1" class="ubislider-inner">
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/embossed-perforated-cable-tray/01.jpg">
                                                </a> </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/embossed-perforated-cable-tray/02.jpg">
                                                </a> </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/embossed-perforated-cable-tray/03.jpg">
                                                </a> </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="inner-box">
                                <div class="lower-content">
                                    <div class="text text-justify">
                                        <p>Jetcotech are offered an innovative product range of Cable Management system,
                                            we offered Embossed Perforated Cable Tray with Heavy Duty Return Flange made
                                            from minimum Thickness, With Pre-GI, Hot Dip Galvanized, and Powder Coated
                                            are the various Finishes produced in our factories. Embossed Cable Tray are
                                            designed to meet most requirements of cable and electrical wire
                                            installations and comply to local and international standards of fabrication
                                            and Finishing.</p>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>100</td>
                                                            <td rowspan="6">35/50/80</td>
                                                            <td rowspan="2">1 / 1.2 / 1.5</td>
