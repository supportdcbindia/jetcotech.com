...
<head>
    ...
    $productName = "Raceway Cable Tray";
...
<body>
    <div class="page-wrapper product">
        ...
        <section class="page-title" style="background-image:url(images/background/wire-mesh-cable-tray-bg.jpg)">
            <div class="auto-container">
                <div class="content">
                    <h1>Raceway Cable Tray <?= ucfirst($type); ?> in <?= ucfirst($city); ?></h1>
                    <ul class="page-breadcrumb">
                        <li><a href="index.html">Home</a></li>
                        <li>Cable Tray</li>
                        <li>Raceway Cable Tray</li>
                    </ul>
                </div>
            </div>
        </section>
                        ...
                        <aside class="sidebar default-sidebar">
                            <div class="sidebar-widgets sidebar-blog-categorys">
                                <div class="clearfix">
                                    <div class="ubislider-image-container left" data-ubislider="#pdrzoom"
                                        ...
                                        <img src="images/pdr/cable-tray/raceway-cable-tray/01.jpg">
                                    </div>
                                    <div id="pdrzoom" class="ubislider right ecommerce" data-slidetime="0">
                                        ...
                                        <ul id="gal1" class="ubislider-inner">
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/raceway-cable-tray/01.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/raceway-cable-tray/02.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/raceway-cable-tray/03.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/raceway-cable-tray/04.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/raceway-cable-tray/05.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/raceway-cable-tray/06.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/raceway-cable-tray/07.jpg"> </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sidebar-widget sidebar-blog-category">
                                ...
                                <ul class="list-link features_list">
                                    ...
                                    <li><a class="first_link" href="javascript:;">Use of vice versa for different kind
                                            of Power and Control Cables</a></li>
                                </ul>
                            </div>
                        </aside>
                    </div>
                            ...
                            <div class="inner-box">
                                <div class="lower-content">
                                    <div class="text text-justify">
                                        <p>Race way cable truncking and accessories are offered in a comprehensive
                                            range. With Pre-GI, Hot Dip Galvanized, and Powder Coated are the various
                                            Finishes produced in our factories. Race way are designed to meet most
                                            requirements of cable and electrical wire installations and comply to local
                                            and international standards of fabrication and FInishing. We are offered
                                            Race way with Single, Double and Triple Compartments and with required
                                            accessories for easy to install. We offered Race Way Trucking System with
                                            Heavy duty return Range with Flapped type cover. Race Way are commonly used
                                            in Industry, Machine Manufacturer, Commercial and Residential Buildings.</p>

                                        <div class="sec-title mb-10">
                                            <h2>Product Range</h2>
                                        </div>
                                        <p class=" text mb-0 font-16"><span class="bold-text mb-0">Raw Material :
                                            </span> Mild Steel, Pre-Galvanized</p>
                                        <p class=" text mb-0 font-14"><span class="bold-text mb-0">Finished : </span>
                                            Hot Dip Galvanized (As per IS), Pre-Galvanized, Powder Coated</p>
                                        <blockquote>
                                                ...
                                                <table class="table table-bordered mb-0">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th scope="col">Thickness (T) mm</th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td rowspan="3">1.2/1.5/1.6/2</td>
                                                            <td rowspan="8">2500/3000</td>
                                                        </tr>
                                                        <tr>
                                                            <td>100</td>
                                                        </tr>
...
$('.RacewayCableTray').addClass(' current ');
</script>