                            ...
                            <div class="sidebar-widgets sidebar-blog-categorys">
                                <div class="clearfix">
                                    <div class="ubislider-image-container left" data-ubislider="#pdrzoom"
                                        ...
                                        <img src="images/pdr/lighting-poles/conical-poles/01.jpg" />
                                    </div>
                                    <div id="pdrzoom" class="ubislider right ecommerce" data-slidetime="0">
                                        ...
                                        <ul id="gal1" class="ubislider-inner">
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/lighting-poles/conical-poles/01.jpg"> </a> </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/lighting-poles/conical-poles/02.jpg"> </a> </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/lighting-poles/conical-poles/03.jpg"> </a> </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/lighting-poles/conical-poles/04.jpg"> </a> </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/lighting-poles/conical-poles/05.jpg"> </a> </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/lighting-poles/conical-poles/06.jpg"> </a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="inner-box">
                                <div class="lower-content">
                                    <div class="text text-justify">
                                        <p>In Jetcotech's extensive range of products, we also offer our esteemed
                                            clients a broad array of Conical Poles. These poles are manufactured using
                                            quality assured steel that is procured from trusted vendors of the market
                                            with the help of latest technology. Further, these Conical Poles are
                                            available in various specifications as per our client's requirements with
                                            utmost quality.</p>
                                        <p>Conical poles are also continuously tapered poles with circular cross section
                                            at both the ends. These are manufactured by press forming sheets under press
                                            brakes. Unlike polygonal cross section poles, conical poles give a much
                                            better and smoother appearance. They are mainly used for lighting, traffic
                                            light & CCTV applications on highways, streets, residential complexes, parks
                                            etc.</p>
                                        <blockquote>
