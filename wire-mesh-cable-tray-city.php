...
<head>
    ...
    $productName = "Wire Mesh Cable Tray";
...
<body>
    <div class="page-wrapper product">
        ...
        <section class="page-title" style="background-image:url(images/background/wire-mesh-cable-tray-bg.jpg)">
            <div class="auto-container">
                <div class="content">
                    <h1>Wire Mesh Cable Tray <?= ucfirst($type); ?> in <?= ucfirst($city); ?></h1>
                    <ul class="page-breadcrumb">
                        <li><a href="index.html">Home</a></li>
                        <li>Cable Tray</li>
                        <li>Wire Mesh Cable Tray</li>
                    </ul>
                </div>
            </div>
        </section>
                        ...
                        <aside class="sidebar default-sidebar">
                            <div class="sidebar-widgets sidebar-blog-categorys">
                                <div class="clearfix">
                                    <div class="ubislider-image-container left" data-ubislider="#pdrzoom"
                                        ...
                                        <img src="images/pdr/cable-tray/wire-mesh-cable-tray/01.jpg">
                                    </div>
                                    <div id="pdrzoom" class="ubislider right ecommerce" data-slidetime="0">
                                        ...
                                        <ul id="gal1" class="ubislider-inner">
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/01.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/02.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/03.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/04.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/05.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/06.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/07.jpg"> </a>
                                            </li>
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/cable-tray/wire-mesh-cable-tray/08.webp"> </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sidebar-widget sidebar-blog-category">
                                ...
                                <ul class="list-link features_list">
                                    <li><a class="first_link" href="javascript:;">Fastest system to install</a></li>
                                    <li><a class="first_link" href="javascript:;">Flawless Finish</a></li>
                                    <li><a class="first_link" href="javascript:;">Good looks in interior points too</a>
                                    </li>
                                    <li><a class="first_link" href="javascript:;">Open structure maximizes ventilation,
                                            decreases collection of debris, and simplifies maintenance work</a></li>
                                    <li><a class="first_link" href="javascript:;">Features a unique, patented safety
                                            edge to prevent injuries and damage to cable sheathing.</a></li>
                                </ul>
                            </div>
                        </aside>
                    </div>
                            ...
                            <div class="inner-box">
                                <div class="lower-content">
                                    <div class="text text-justify">
                                        <p>Creating a niche of Wire Mesh Cable Tray and Cable Tray Accessories at its
                                            best, with utmost quality.</p>
                                        <p>Wire Mesh Cable Tray systems enable fast and simple connections with limited
                                            need for tools. Its design allows continuous airow, and prevents the
                                            buildup of dust, contaminants and bacterial proliferation. Strong, Flexible,
                                            and adaptable, our Wire Mesh Cable Trays come in a full range of sizes and
                                            is made with high-strength welded steel wires. Support accessories for any
                                            application or situation are available. Wire Mesh Cable Tray is produced by
                                            rst welding a net, forming the channel and then Flexible after fabrication.
                                            Commonly used for Telecoms, IT, Food Industries, Other Industrial Control &
                                            Power Cabling Managements.</p>

                                        <div class="sec-title mb-10">
                                            <h2>Product Range</h2>
                                        </div>
                                        <p class=" text mb-0 font-16"><span class="bold-text mb-0">Raw Material :
                                            </span> Mild Steel Wire , Stainless Steel Wire 202,304,316</p>
                                        <p class=" text mb-0 font-14"><span class="bold-text mb-0">Finished : </span>
                                            Hot Dip Galvanized (As per IS), Electroplated, Powder Coated, SS Self, SS
                                            Mirror</p>
                                        <blockquote>
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">Width (W) mm</th>
                                                            <th scope="col">Height (H) mm</th>
                                                            <th scope="col">Wire Gauge (D) mm</th>
                                                            <th scope="col">Length (L) mm</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td>50</td>
                                                            <td rowspan="3">25/50/75/100</td>
                                                            <td rowspan="3">3/4/5</td>
                                                            <td rowspan="8">2500</td>
                                                        </tr>
                                                        <tr>
                                                            <td>100</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>200</td>
                                                            <td rowspan="5">50/75/100</td>
                                                            <td rowspan="5">4/5/6</td>
                                                        </tr>
                                                        <tr>
                                                            <td>300</td>
                                                        </tr>
...
<script>
    ...
    $('.WireMeshCableTray').addClass(' current ');
</script>