...
<head>
    ...
    $productName = "Frp Perforated Cable Tray";
...
<body>
    <div class="page-wrapper product">
        ...
        <section class="page-title" style="background-image:url(images/background/perforatted-cable-tray-bg.jpg)">
            <div class="auto-container">
                <div class="content">
                    <h1>Frp Perforated Cable Tray <?= ucfirst($type); ?> in <?= ucfirst($city); ?></h1>
                    <ul class="page-breadcrumb">
                        <li><a href="index.html">Home</a></li>
                        <li>Frp Products</li>
                        <li>Frp Perforated Cable Tray</li>
                    </ul>
                </div>
            </div>
        </section>
                            ...
                            <div class="sidebar-widgets sidebar-blog-categorys">
                                <div class="clearfix">
                                    <div class="ubislider-image-container left" data-ubislider="#pdrzoom"
                                        ...
                                        <img
                                            src="images/pdr/frp-products/frp-perforated-cable-tray/frp-perforated-cable-tray.webp">
                                    </div>
...
<script>
    ...
    jQuery('.FrpPerforatedCableTray').addClass(' current ');
</script>