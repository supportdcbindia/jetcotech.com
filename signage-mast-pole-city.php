...
<?php */ ?>
    ...
    $productName = "Signage Mast Poles";
...
<body>
    <div class="page-wrapper product">
        ...
        <section class="page-title" style="background-image:url(images/background/high-mast-poles-bg.jpg)">
            <div class="auto-container">
                <div class="content">
                    <h1>Signage Mast Poles <?= ucfirst($type); ?> in <?= ucfirst($city); ?></h1>
                    <ul class="page-breadcrumb">
                        <li><a href="index.html">Home</a></li>
                        <li>Mast Poles</li>
                        <li>Signage Mast Poles</li>
                    </ul>
                </div>
            </div>
        </section>
                                    ...
                                    <div id="pdrzoom" class="ubislider right ecommerce" data-slidetime="0">
                                        ...
                                        <ul id="gal1" class="ubislider-inner">
                                            <li> <a> <img class="product-v-img"
                                                        src="images/pdr/mast-poles/signage-mast-pole/signage-mast-pole.webp">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="auto-container">
                ...
                <div class="products-intro-content">
                    ...
                    <p>
                        ...
                        mast pole solutions for outdoor signage, road infrastructure,
                        highways and other applications requiring elevated signage
                        support.
                    </p>

                    <p>
                        Our Signage Mast Poles are developed for projects where
                        reliable structural support, suitable height and effective
                        visibility of large outdoor signage are important.
                    </p>
            ...
            <div class="auto-container">
                ...
                <div class="products-seo-inner">
                    ...
                    <p>
                        ...
                        signage mast pole solutions for outdoor signage and
                        infrastructure projects where signs need to be installed at
                        an appropriate height for clear visibility.
                    </p>

                    <p>
                        Signage Mast Poles are suitable for applications such as
                        highways, roads, commercial developments, industrial
                        premises, infrastructure projects and other outdoor
                        locations requiring elevated signage support.
                    </p>

                    <p>
                        JETCOTECH focuses on application-oriented manufacturing,
                        allowing signage mast pole solutions to be considered
                        according to project requirements, installation conditions,
                        signage dimensions and required pole configuration.
                    </p>

                    <p>
                        The appropriate mast pole arrangement can be selected based
                        on factors such as required height, signage size, location,
                        structural requirements and installation conditions.
                        Customers in <?= htmlspecialchars($cityName); ?> can discuss
                        their project requirements with JETCOTECH for a suitable
                        signage mast pole solution.
                    </p>

                    <p>
                        With its manufacturing capabilities and experience in
                        industrial infrastructure products, JETCOTECH serves
...
<script>
    ...
    $('.SignageMastPoles').addClass(' current ');
</script>