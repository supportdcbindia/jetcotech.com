...
<body>
    <div class="page-wrapper product">
        ...
        <section class="page-title" style="background-image:url(images/background/perforatted-cable-tray-bg.jpg)">
            <div class="auto-container">
                <div class="content">
                    <h1>Cable Tray <?= ucfirst($type); ?> in <?= ucfirst($city); ?></h1>
                        ...
                        <div class="case-study-single-box">
                            ...
                            <div class="case-study-content">
                                <div class="case-study-title">
                                    <h3>
                                        <a href="perforated-cable-tray-<?= $type ?>-in-<?= $city ?>.php">
                                ...
                                <div class="product-card-actions">
                                    <a href="perforated-cable-tray-<?= $type ?>-in-<?= $city ?>.php" class="product-view-btn">
                                        View Details
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="case-study-single-box">
                            ...
                            <div class="case-study-content">
                                <div class="case-study-title">
                                    <h3>
                                        <a href="ladder-cable-tray-<?= $type ?>-in-<?= $city ?>.php">
                                            Ladder Cable Tray
                                        </a>
                                    </h3>
                                </div>
                                ...
                                <div class="product-card-actions">
                                    <a href="ladder-cable-tray-<?= $type ?>-in-<?= $city ?>.php" class="product-view-btn">
                                        View Details
                                        <i class="fa fa-arrow-right"></i>
                                    </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="case-study-single-box">
                            ...
                            <div class="case-study-content">
                                <div class="case-study-title">
                                    <h3>
                                        <a href="wire-mesh-cable-tray-<?= $type ?>-in-<?= $city ?>.php">
                                ...
                                <div class="product-card-actions">
                                    <a href="wire-mesh-cable-tray-<?= $type ?>-in-<?= $city ?>.php" class="product-view-btn">
                                        View Details
                                        <i class="fa fa-arrow-right"></i>
                                    </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="case-study-single-box">
                            ...
                            <div class="case-study-content">
                                <div class="case-study-title">
                                    <h3>
                                        <a href="raceway-cable-tray-<?= $type ?>-in-<?= $city ?>.php">
                                            Raceway Cable Tray
                                        </a>
                                    </h3>
                                </div>
                                ...
                                <div class="product-card-actions">
                                    <a href="raceway-cable-tray-<?= $type ?>-in-<?= $city ?>.php" class="product-view-btn">
                                        View Details
                                        <i class="fa fa-arrow-right"></i>
                                    </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="case-study-single-box">
                            ...
                            <div class="case-study-content">
                                <div class="case-study-title">
                                    <h3>
                                        <a href="embossed-perforated-cable-tray-<?= $type ?>-in-<?= $city ?>.php">
                                ...
                                <div class="product-card-actions">
                                    <a href="embossed-perforated-cable-tray-<?= $type ?>-in-<?= $city ?>.php" class="product-view-btn">
                                        View Details
                                        <i class="fa fa-arrow-right"></i>
                                    </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="case-study-single-box">
                            ...
                            <div class="case-study-content">
                                <div class="case-study-title">
                                    <h3>
                                        <a href="heavy-duty-ladder-cable-tray-<?= $type ?>-in-<?= $city ?>.php">
                                ...
                                <div class="product-card-actions">
                                    <a href="heavy-duty-ladder-cable-tray-<?= $type ?>-in-<?= $city ?>.php" class="product-view-btn">
                                        View Details
                                        <i class="fa fa-arrow-right"></i>
                                    </a>
